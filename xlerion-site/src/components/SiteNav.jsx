                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 top-0 pt-12 hidden group-hover:block">
                                    <div className="bg-black/85 backdrop-blur-sm rounded-md p-3 border border-[#00e9fa]/20 shadow-[0_10px_30px_rgba(0,0,0,0.45)] min-w-[220px]">
                                        <div className="flex flex-col gap-2 text-[13px] font-work uppercase tracking-[0.2em] font-light items-start">
                                            ...
                                            <a href="/recursos/analiticas" onClick={() => { try { document.title = 'nav:/recursos/analiticas'; } catch (e) { } setMobileMenuOpen(false); }} className="inline-flex items-center h-8 px-2 w-full text-left hover:text-[#00e9fa] transition-colors">{t('nav_analytics')}</a>
                                            <a href="/recursos/publicidad" onClick={() => { try { document.title = 'nav:/recursos/publicidad'; } catch (e) { } setMobileMenuOpen(false); }} className="inline-flex items-center h-8 px-2 w-full text-left hover:text-[#00e9fa] transition-colors">{t('nav_advertising')}</a>
                            ...
                            <div className="border-b border-white/10 pb-6">
                                ...
                                {recursosOpen && (
                                    <div className="flex flex-col gap-3 mt-4">
                                        ...
                                        <a href="/recursos/analiticas" onClick={() => setMobileMenuOpen(false)} className="text-lg text-gray-300 hover:text-[#00e9fa] transition-colors uppercase tracking-wider">{t('nav_analytics')}</a>
                                        <a href="/recursos/publicidad" onClick={() => setMobileMenuOpen(false)} className="text-lg text-gray-300 hover:text-[#00e9fa] transition-colors uppercase tracking-wider">{t('nav_advertising')}</a>
