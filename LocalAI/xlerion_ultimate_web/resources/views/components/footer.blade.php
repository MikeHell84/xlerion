    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="footer-columna mb-6">
                <a href="/contacto" class="footer-titulo flex items-center font-bold text-lg hover:text-teal-400 transition"><i class="fas fa-phone mr-2"></i>Contacto</a>
                <ul class="space-y-2">
                ...
                <a href="/contacto" class="footer-titulo flex items-center font-bold text-lg hover:text-teal-400 transition mt-4"><i class="fas fa-envelope mr-2"></i>Email</a>
                <ul class="space-y-2">
            ...
            <div class="footer-columna mb-6">
                <a href="/legal" class="footer-titulo flex items-center font-bold text-lg hover:text-teal-400 transition"><i class="fas fa-gavel mr-2"></i>Legal</a>
                <ul class="space-y-2">
            ...
            <div class="footer-columna mb-6">
                <h3 class="footer-titulo font-bold text-lg">Redes Sociales</h3>
